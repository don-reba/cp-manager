...
${CMTROOT}/mgr/cmt setup -sh -pack=SampleGpuHandler -version=v1r1 -path=/home/dcampora/projects/gaudi/new-gaudi-gpu-manager-dev/Brunel_v47r2p1/GpuManager  -no_cleanup $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
