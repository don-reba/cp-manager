...
${CMTROOT}/mgr/cmt setup -csh -pack=GpuServer -version=v1r1 -path=/home/dcampora/projects/gaudi/new-gaudi-gpu-manager-dev/Brunel_v47r2p1/GpuManager  -no_cleanup $* >${tempfile}; source ${tempfile}
/bin/rm -f ${tempfile}
