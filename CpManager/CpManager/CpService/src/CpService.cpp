...
#include "CpIpc/TcpSocketClient.h"
...
DECLARE_SERVICE_FACTORY(CpService)

//-------------
// construction
//-------------

CpService::CpService(const std::string & name, ISvcLocator * sl) :
    base_class        (name, sl),
    m_transport       (nullptr),
    m_protocol        (nullptr),
    m_connectionType  ("local"),
    m_localSocketPath ("/tmp/CpManager"),
...
//-----------------------------
// ICpService implementation
//-----------------------------

void CpService::submitData(
...
StatusCode CpService::initialize() {
