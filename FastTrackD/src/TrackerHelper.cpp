...
void TrackerHelper::buildTypestruct(char* dataPointer){
  /* Expected format:
  no_sensors - int
  no_hits    - int
...
void TrackerHelper::fill_hit_sensorNums(){
...
void TrackerHelper::printResultTracks(std::vector<track> tracks, int event_no, std::string track_folder_container) const{
